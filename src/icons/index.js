...
export const IconStatus = () => (
    <svg width="32" height="32" className="_1wVHI" viewBox="0 0 32 32" version="1.1" aria-hidden="false">
        <path
...
export const IconContributions = () => (
    <svg width="32" height="32" className="_1wVHI" viewBox="0 0 32 32" version="1.1" aria-hidden="false">
        <path
...
export const IconTopContributors = () => (
    <svg width="32" height="32" className="_1wVHI" viewBox="0 0 32 32" version="1.1" aria-hidden="false">
        <path
...
export const IconAddUser = () => (
    <svg width="32" height="32" className="ONxrv" viewBox="0 0 32 32" version="1.1" aria-hidden="false">
        <path
